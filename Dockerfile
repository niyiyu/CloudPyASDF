...
RUN apt update; apt install -y build-essential libreadline-dev liblua5.3-dev cmake libcurl4-openssl-dev libssl-dev uuid-dev zlib1g-dev unzip wget htop
...
RUN pip install pybind11 numpy jupyter h5py xarray; conda install -c conda-forge obspy
